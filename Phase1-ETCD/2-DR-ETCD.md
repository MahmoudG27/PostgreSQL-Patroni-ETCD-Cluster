...
> | ------ | ------------ | ---------- |
> | Node 1 | `dr-node-01` | `10.1.0.4` |
> | Node 2 | `dr-node-02` | `10.1.0.5` |
> | Node 3 | `dr-node-03` | `10.1.0.6` |
> | Node 4 | `dr-node-04` | `10.1.0.7` |
> | Node 5 | `dr-node-05` | `10.1.0.8` |
...
```bash
getent hosts dr-node-01
getent hosts dr-node-02
getent hosts dr-node-03
getent hosts dr-node-04
getent hosts dr-node-05
```
...
```text
dr-node-01=http://10.1.0.4:2380
dr-node-02=http://10.1.0.5:2380
dr-node-03=http://10.1.0.6:2380
dr-node-04=http://10.1.0.7:2380
dr-node-05=http://10.1.0.8:2380
```
...
On **`dr-node-02` (`10.1.0.5`)**, use the same configuration but change the node-specific values:
