...
> | ------ | ---------- | ---------- |
> | Node 1 | `pg-node1` | `10.0.0.4` |
> | Node 2 | `pg-node2` | `10.0.0.5` |
> | Node 3 | `pg-node3` | `10.0.0.6` |
> | Node 4 | `pg-node4` | `10.0.0.7` |
> | Node 5 | `pg-node5` | `10.0.0.8` |
...
```text
pg-node1=http://10.0.0.4:2380
pg-node2=http://10.0.0.5:2380
pg-node3=http://10.0.0.6:2380
pg-node4=http://10.0.0.7:2380
pg-node5=http://10.0.0.8:2380
```
...
On **`pg-node2` (`10.0.0.5`)**, use the same configuration but change the node-specific values:
